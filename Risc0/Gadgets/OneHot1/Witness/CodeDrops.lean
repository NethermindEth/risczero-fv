...
lemma getReturn_ignores_drops :
  getReturn (Γ st ⟦part0;part1;part2;part3;dropfelt ⟨"%8"⟩;dropfelt ⟨"%2"⟩;dropfelt ⟨"%1"⟩;dropfelt ⟨"%3"⟩;dropfelt ⟨"%0"⟩;dropfelt ⟨"%4"⟩;dropfelt ⟨"%5"⟩;dropfelt ⟨"%6"⟩;dropfelt ⟨"%7"⟩⟧) res0 =
  getReturn (Γ st ⟦part0;part1;part2;part3⟧) res0 := by
