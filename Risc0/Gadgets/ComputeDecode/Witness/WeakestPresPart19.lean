...
def part19_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%29" : FeltVar }] ←
                (st.felts { name := "%28" : FeltVar }).get! * (st.felts { name := "%13" : FeltVar }).get!)["%30"] ←ₛ
              getImpl st { name := "data" : BufferVar } (0 : Back) (1 : ℕ))[felts][{ name := "%31" : FeltVar }] ←
            (((st[felts][{ name := "%29" : FeltVar }] ←
                        (st.felts { name := "%28" : FeltVar }).get! *
                          (st.felts { name := "%13" : FeltVar }).get!)["%30"] ←ₛ
                      getImpl st { name := "data" : BufferVar } (0 : Back) (1 : ℕ)).felts
                  { name := "%30" : FeltVar }).get! *
              (st.felts { name := "%15" : FeltVar }).get!)[felts][{ name := "%32" : FeltVar }] ←
          (((st[felts][{ name := "%29" : FeltVar }] ←
                        (st.felts { name := "%28" : FeltVar }).get! *
                          (st.felts { name := "%13" : FeltVar }).get!)["%30"] ←ₛ
                      getImpl st { name := "data" : BufferVar } (0 : Back) (1 : ℕ)).felts
            ...
            (st.felts { name := "%28" : FeltVar }).get! * (st.felts { name := "%13" : FeltVar }).get!) 
