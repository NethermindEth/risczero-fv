  ...
  Code.getReturn
        (part25_state_update
          ((({
                  ...
                  vars :=
                    [{ name := "in" : BufferVar },
                      { name := "data" : BufferVar }] }[felts][{ name := "%43" : FeltVar }] ←
                feltBitAnd x2 (12 : Felt) * (1509949441 : Felt) * (4 : Felt))[felts][{ name := "%49" : FeltVar }] ←
              feltBitAnd x2 (128 : Felt) * (1997537281 : Felt) * (8 : Felt) +
                feltBitAnd x2 (96 : Felt) * (1950351361 : Felt) * (2 : Felt))[felts][{ name := "%44" : FeltVar }] ←
