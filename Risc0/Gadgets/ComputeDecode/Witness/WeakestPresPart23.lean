...
lemma part23_updates_opaque {st : State} : 
  ...
  Code.getReturn (part23_state_update (part22_drops (part22_state st))) = [y0, y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16, y17] := by
  simp [part22_state_update, part23_wp]

lemma part23_cumulative_wp {x0 x1 x2 x3: Felt} :
