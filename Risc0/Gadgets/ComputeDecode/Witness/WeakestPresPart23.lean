...
def part23_state (st: State) : State :=
          ...
          ((((st["%42"] ←ₛ getImpl st { name := "data" } (0 : Back) (4 : ℕ))[felts][{ name := "%43" }] ←
                Option.get!
                    (State.felts (st["%42"] ←ₛ getImpl st { name := "data" } (0 : Back) (4 : ℕ)) { name := "%42" }) *
                  Option.get! (State.felts st { name := "%7" }))["%45"] ←ₛ
              getImpl st { name := "data" } (0 : Back) (2 : ℕ))[felts][{ name := "%46" }] ←
            Option.get!
                (State.felts
                  (((st["%42"] ←ₛ getImpl st { name := "data" } (0 : Back) (4 : ℕ))[felts][{ name := "%43" }] ←
                      Option.get!
                          (State.felts (st["%42"] ←ₛ getImpl st { name := "data" } (0 : Back) (4 : ℕ))
                            { name := "%42" }) *
                        Option.get! (State.felts st { name := "%7" }))["%45"] ←ₛ
