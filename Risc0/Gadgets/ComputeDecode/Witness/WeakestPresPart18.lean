...
def part18_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%7" : FeltVar }] ← (4 : Felt))["%26"] ←ₛ
              getImpl st { name := "data" : BufferVar } (0 : Back) (8 : ℕ))[felts][{ name := "%27" : FeltVar }] ←
            (((st[felts][{ name := "%7" : FeltVar }] ← (4 : Felt))["%26"] ←ₛ
...
lemma part18_cumulative_wp {in0 in1 in2 in3: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17: Option Felt} :
