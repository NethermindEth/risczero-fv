...
def part0_state (st: State) : State :=
          ...
          ((((st[felts][{ name := "%19" }] ← (128 : Felt))["%23"] ←ₛ
                getImpl st { name := "in" } (0 : Back) (3 : ℕ))[felts][{ name := "%74" }] ←
              feltBitAnd
                (Option.get!
                  (State.felts
                    ((st[felts][{ name := "%19" }] ← (128 : Felt))["%23"] ←ₛ
...
lemma part0_cumulative_wp {x0 x1 x2 x3: Felt} :
                ...
                [({ name := "in" }, [[some x0, some x1, some x2, some x3]]),
                  ({ name := "data" },
                    [[none, none, none, none, none, none, none, none, none, none, none, none, none, none, none, none,
                        none, none]])],
            bufferWidths := Map.fromList [({ name := "in" }, (4 : ℕ)), ({ name := "data" }, (18 : ℕ))],
