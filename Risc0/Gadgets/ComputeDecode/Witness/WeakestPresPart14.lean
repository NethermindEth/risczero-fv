...
def part14_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%1" : FeltVar }] ← (48 : Felt))[felts][{ name := "%98" : FeltVar }] ←
              ...
              feltBitAnd (st.felts { name := "%21" : FeltVar }).get! (48 : Felt) *
...
lemma part14_cumulative_wp {in0 in1 in2 in3: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17: Option Felt} :
