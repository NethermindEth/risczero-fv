...
def part24_state (st: State) : State :=
        ...
        ((((st["%47"] ←ₛ
              ...
              ((st["%47"] ←ₛ getImpl st { name := "data" : BufferVar } (0 : Back) (12 : ℕ)).felts
                    { name := "%47" : FeltVar }).get! *
                (st.felts { name := "%13" : FeltVar }).get!)[felts][{ name := "%49" : FeltVar }] ←
            ((st["%47"] ←ₛ getImpl st { name := "data" : BufferVar } (0 : Back) (12 : ℕ)).felts
                    { name := "%47" : FeltVar }).get! *
                (st.felts { name := "%13" : FeltVar }).get! +
...
lemma part24_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 : Option Felt} :
  ...
  Code.getReturn (part24_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17]) := by
...
lemma part24_updates_opaque {st : State} : 
  Code.getReturn (part23_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17]) ↔
  Code.getReturn (part24_state_update (part23_drops (part23_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17]) := by
  try simp [part23_state_update, part24_wp]

lemma part24_cumulative_wp {in0 in1 in2 in3: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17: Option Felt} :
  ...
  Code.getReturn
      (part24_state_update
        (({
            ...
            feltBitAnd in2 (12 : Felt) * (1509949441 : Felt) * (4 : Felt))[felts][{ name := "%46" : FeltVar }] ←
