...
def part₀_state_update (st: State): State :=
  Γ (part₀_state st) ⟦Code.part₁; Code.part₂₀; Code.part₂₁; Code.part₂₂; Code.part₃; Code.part₄; Code.part₅; Code.part₆; Code.part₇; Code.part₈⟧
...
lemma part₀_wp {st : State} {y₁ y₂ y₃ : Option Felt} :
  ...
  generalize eq : (Code.part₁; Code.part₂₀; Code.part₂₁; Code.part₂₂; Code.part₃; Code.part₄; Code.part₅; Code.part₆; Code.part₇; Code.part₈) = prog
  unfold Code.part₀
  MLIR
