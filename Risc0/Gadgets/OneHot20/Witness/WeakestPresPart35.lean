...
lemma part35_updates_opaque {st : State} : 
  Code.getReturn (part34_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part35_state_update (part34_drops (part34_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part34_state_update, part35_wp]

lemma part35_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
      ...
      (part35_state_update
        {
          ...
          felts :=
            ((((((((((((((((((((Map.empty[{ name := "%18" : FeltVar }] ←ₘ (1 : Felt))[{ name := "%22" : FeltVar }] ←ₘ
                ...
                if code0 - (19 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[{ name := "%77" : FeltVar }] ←ₘ
