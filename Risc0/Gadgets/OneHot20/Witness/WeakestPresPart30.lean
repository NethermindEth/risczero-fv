...
def part30_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%62" : FeltVar }] ←
                Option.get! (State.felts st { name := "%61" : FeltVar }) *
                  Option.get! (State.felts st { name := "%4" : FeltVar }))[felts][{ name := "%63" : FeltVar }] ←
              Option.get! (State.felts st { name := "%60" : FeltVar }) +
                Option.get! (State.felts st { name := "%61" : FeltVar }) *
                  Option.get! (State.felts st { name := "%4" : FeltVar }))["%64"] ←ₛ
      ...
      (part30_state_update
        (((((((((((((((({
            ...
            (if code0 - (1 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt)) +
                    ...
                    (if code0 - (11 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt)) * (11 : Felt) +
