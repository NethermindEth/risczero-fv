...
def part30_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%62" : FeltVar }] ←
                (st.felts { name := "%61" : FeltVar }).get! *
                  (st.felts { name := "%4" : FeltVar }).get!)[felts][{ name := "%63" : FeltVar }] ←
              (st.felts { name := "%60" : FeltVar }).get! +
                (st.felts { name := "%61" : FeltVar }).get! * (st.felts { name := "%4" : FeltVar }).get!)["%64"] ←ₛ
            getImpl st { name := "data" : BufferVar } (0 : Back) (16 : ℕ))[felts][{ name := "%65" : FeltVar }] ←
          ((((st[felts][{ name := "%62" : FeltVar }] ←
                        (st.felts { name := "%61" : FeltVar }).get! *
                          (st.felts { name := "%4" : FeltVar }).get!)[felts][{ name := "%63" : FeltVar }] ←
                      (st.felts { name := "%60" : FeltVar }).get! +
                        (st.felts { name := "%61" : FeltVar }).get! *
                          (st.felts { name := "%4" : FeltVar }).get!)["%64"] ←ₛ
                    getImpl st { name := "data" : BufferVar } (0 : Back) (16 : ℕ)).felts
                { name := "%64" : FeltVar }).get! *
...
lemma part30_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19 : Option Felt} :
  ...
  Code.getReturn (part30_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
...
lemma part30_updates_opaque {st : State} : 
  Code.getReturn (part29_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part30_state_update (part29_drops (part29_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part29_state_update, part30_wp]

lemma part30_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
  ...
  Code.getReturn
      (part30_state_update
        (((((((((((((((({
              ...
              if code0 - (14 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%60" : FeltVar }] ←
