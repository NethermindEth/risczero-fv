...
def part48_state (st: State) : State :=
        ...
        ((withEqZero
            ((st.felts { name := "%58" : FeltVar }).get! *
              ((st.felts { name := "%18" : FeltVar }).get! - (st.felts { name := "%58" : FeltVar }).get!))
            ((st[felts][{ name := "%119" : FeltVar }] ←
                (st.felts { name := "%18" : FeltVar }).get! -
                  (st.felts { name := "%58" : FeltVar }).get!)[felts][{ name := "%120" : FeltVar }] ←
              (st.felts { name := "%58" : FeltVar }).get! *
                ((st.felts { name := "%18" : FeltVar }).get! -
                  (st.felts { name := "%58" : FeltVar }).get!)))[felts][{ name := "%121" : FeltVar }] ←
          (st.felts { name := "%118" : FeltVar }).get! + (st.felts { name := "%58" : FeltVar }).get!) 
...
lemma part48_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19 : Option Felt} :
  ...
  Code.getReturn (part48_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
...
lemma part48_updates_opaque {st : State} : 
  Code.getReturn (part47_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part48_state_update (part47_drops (part47_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part47_state_update, part48_wp]

lemma part48_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
  ...
  Code.getReturn
      (part48_state_update
        ({
            ...
            props := Map.empty,
            vars :=
              [{ name := "code" : BufferVar }, { name := "data" : BufferVar }] }[felts][{ name := "%118" : FeltVar }] ←
