...
lemma part25_updates_opaque {st : State} : 
  Code.getReturn (part24_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part25_state_update (part24_drops (part24_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part24_state_update, part25_wp]

lemma part25_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
  ...
  Code.getReturn
      (part25_state_update
        (((((((((({
                ...
                else (0 : Felt))[felts][{ name := "%39" : FeltVar }] ←
            ...
            if code0 - (8 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%41" : FeltVar }] ←
