...
lemma part25_updates_opaque {st : State} : 
  ...
  Code.getReturn (part25_state_update (part24_drops (part24_state st))) = [y0, y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16, y17, y18, y19] := by
  simp [part24_state_update, part25_wp]

lemma part25_cumulative_wp {x0: Felt} :
  ...
  Code.getReturn
        (part25_state_update
          (((((((((({
                  ...
                  if x0 - (7 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%39" : FeltVar }] ←
              ...
              if x0 - (8 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%41" : FeltVar }] ←
