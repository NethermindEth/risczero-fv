...
def part25_state (st: State) : State :=
          ...
          ((((st[felts][{ name := "%42" }] ←
                  Option.get! (State.felts st { name := "%39" }) +
                    Option.get! (State.felts st { name := "%41" }))["%43"] ←ₛ
                getImpl st { name := "data" } (0 : Back) (9 : ℕ))[felts][{ name := "%44" }] ←
              Option.get!
                  (State.felts
                    ((st[felts][{ name := "%42" }] ←
                        Option.get! (State.felts st { name := "%39" }) +
                          Option.get! (State.felts st { name := "%41" }))["%43"] ←ₛ
                      getImpl st { name := "data" } (0 : Back) (9 : ℕ))
                    { name := "%43" }) *
                Option.get! (State.felts st { name := "%10" }))[felts][{ name := "%45" }] ←
            Option.get! (State.felts st { name := "%39" }) + Option.get! (State.felts st { name := "%41" }) +
              Option.get!
                  (State.felts
                    ((st[felts][{ name := "%42" }] ←
                        Option.get! (State.felts st { name := "%39" }) +
  ...
  Code.getReturn
        (part25_state_update
          (((((((((({
                  ...
                  if x0 - (7 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%39" }] ←
                (if x0 - (1 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt)) +
                  ...
                  (if x0 - (7 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt)) *
                    (7 : Felt))[felts][{ name := "%40" }] ←
              if x0 - (8 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%41" }] ←
