...
def part25_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%42" : FeltVar }] ←
                Option.get! (State.felts st { name := "%39" : FeltVar }) +
                  Option.get! (State.felts st { name := "%41" : FeltVar }))["%43"] ←ₛ
            ...
            Option.get!
                (State.felts
                  ...
                  { name := "%43" : FeltVar }) *
              Option.get! (State.felts st { name := "%10" : FeltVar }))[felts][{ name := "%45" : FeltVar }] ←
          Option.get! (State.felts st { name := "%39" : FeltVar }) +
            ...
            Option.get!
                (State.felts
                  ((st[felts][{ name := "%42" : FeltVar }] ←
                    ...
                    getImpl st { name := "data" : BufferVar } (0 : Back) (9 : ℕ))
                  { name := "%43" : FeltVar }) *
              Option.get! (State.felts st { name := "%10" : FeltVar })) 
