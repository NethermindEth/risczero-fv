            ...
            Option.get!
                (State.felts
                  (((st[felts][{ name := "%38" : FeltVar }] ←
                        Option.get! (State.felts st { name := "%37" : FeltVar }) *
                          Option.get!
                            (State.felts st { name := "%12" : FeltVar }))[felts][{ name := "%39" : FeltVar }] ←
                      Option.get! (State.felts st { name := "%36" : FeltVar }) +
                        Option.get! (State.felts st { name := "%37" : FeltVar }) *
                          Option.get! (State.felts st { name := "%12" : FeltVar }))["%40"] ←ₛ
  ...
  Code.getReturn
        (part24_state_update
          (((((((({
                  ...
                  if x0 - (5 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%34" : FeltVar }] ←
                if x0 - (6 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%36" : FeltVar }] ←
