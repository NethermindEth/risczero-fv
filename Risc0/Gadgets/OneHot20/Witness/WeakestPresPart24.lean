...
def part24_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%38" : FeltVar }] ←
                (st.felts { name := "%37" : FeltVar }).get! *
                  (st.felts { name := "%12" : FeltVar }).get!)[felts][{ name := "%39" : FeltVar }] ←
              (st.felts { name := "%36" : FeltVar }).get! +
                (st.felts { name := "%37" : FeltVar }).get! * (st.felts { name := "%12" : FeltVar }).get!)["%40"] ←ₛ
            getImpl st { name := "data" : BufferVar } (0 : Back) (8 : ℕ))[felts][{ name := "%41" : FeltVar }] ←
          ((((st[felts][{ name := "%38" : FeltVar }] ←
                        (st.felts { name := "%37" : FeltVar }).get! *
                          (st.felts { name := "%12" : FeltVar }).get!)[felts][{ name := "%39" : FeltVar }] ←
                      (st.felts { name := "%36" : FeltVar }).get! +
                        (st.felts { name := "%37" : FeltVar }).get! *
                          (st.felts { name := "%12" : FeltVar }).get!)["%40"] ←ₛ
...
lemma part24_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19 : Option Felt} :
  ...
  Code.getReturn (part24_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
...
lemma part24_updates_opaque {st : State} : 
  Code.getReturn (part23_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part24_state_update (part23_drops (part23_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part23_state_update, part24_wp]

lemma part24_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
  ...
  Code.getReturn
      (part24_state_update
        (((((((({
              ...
              if code0 - (6 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%36" : FeltVar }] ←
            (((((if code0 - (1 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt)) +
              ...
              if code0 - (6 : Felt) = (0 : Felt) then (6 : Felt) else (0 : Felt))[felts][{ name := "%37" : FeltVar }] ←
