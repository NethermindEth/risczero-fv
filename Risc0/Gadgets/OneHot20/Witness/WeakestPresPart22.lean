  ...
  Code.getReturn
        (part22_state_update
          (((((({
                  ...
                  if x0 - 3 = 0 then 1 else 0)[felts][{ name := "%27" }] ←
                (if x0 - 1 = 0 then 1 else 0) + (if x0 - 2 = 0 then 1 else 0) * 2 +
                  (if x0 - 3 = 0 then 1 else 0) * 3)[felts][{ name := "%28" }] ←
              if x0 - 4 = 0 then 1 else 0)[felts][{ name := "%29" }] ←
