...
lemma part41_updates_opaque {st : State} : 
  ...
  Code.getReturn (part41_state_update (part40_drops (part40_state st))) = [y0, y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16, y17, y18, y19] := by
  simp [part40_state_update, part41_wp]

lemma part41_cumulative_wp {x0: Felt} :
