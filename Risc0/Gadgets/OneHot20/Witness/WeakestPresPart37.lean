...
lemma part37_updates_opaque {st : State} : 
  ...
  Code.getReturn (part37_state_update (part36_drops (part36_state st))) = [y0, y1, y2, y3, y4, y5, y6, y7, y8, y9, y10, y11, y12, y13, y14, y15, y16, y17, y18, y19] := by
  simp [part36_state_update, part37_wp]

lemma part37_cumulative_wp {x0: Felt} :
