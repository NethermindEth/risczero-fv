...
def part34_state (st: State) : State :=
          ...
          (withEqZero
            (Option.get!
                (State.felts (st["%77"] ←ₛ getImpl st { name := "data" } (0 : Back) (0 : ℕ)) { name := "%77" }) *
              (Option.get! (State.felts st { name := "%18" }) -
                Option.get!
                  (State.felts (st["%77"] ←ₛ getImpl st { name := "data" } (0 : Back) (0 : ℕ)) { name := "%77" })))
            (((st["%77"] ←ₛ getImpl st { name := "data" } (0 : Back) (0 : ℕ))[felts][{ name := "%78" }] ←
                Option.get! (State.felts st { name := "%18" }) -
                  Option.get!
                    (State.felts (st["%77"] ←ₛ getImpl st { name := "data" } (0 : Back) (0 : ℕ))
        ...
        (part34_state_update
          {
            ...
            felts :=
              (((((((((((((((((((Map.empty[{ name := "%18" }] ←ₘ (1 : Felt))[{ name := "%22" }] ←ₘ
                                ...
                                if x0 - (11 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[{ name := "%52" }] ←ₘ
