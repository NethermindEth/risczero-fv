...
def part31_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%66" : FeltVar }] ←
                (st.felts { name := "%63" : FeltVar }).get! + (st.felts { name := "%65" : FeltVar }).get!)["%67"] ←ₛ
              getImpl st { name := "data" : BufferVar } (0 : Back) (17 : ℕ))[felts][{ name := "%68" : FeltVar }] ←
            (((st[felts][{ name := "%66" : FeltVar }] ←
                        (st.felts { name := "%63" : FeltVar }).get! +
                          (st.felts { name := "%65" : FeltVar }).get!)["%67"] ←ₛ
                      getImpl st { name := "data" : BufferVar } (0 : Back) (17 : ℕ)).felts
                  { name := "%67" : FeltVar }).get! *
              (st.felts { name := "%2" : FeltVar }).get!)[felts][{ name := "%69" : FeltVar }] ←
          (st.felts { name := "%63" : FeltVar }).get! + (st.felts { name := "%65" : FeltVar }).get! +
            (((st[felts][{ name := "%66" : FeltVar }] ←
                        (st.felts { name := "%63" : FeltVar }).get! +
                          (st.felts { name := "%65" : FeltVar }).get!)["%67"] ←ₛ
                      getImpl st { name := "data" : BufferVar } (0 : Back) (17 : ℕ)).felts
...
lemma part31_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19 : Option Felt} :
  ...
  Code.getReturn (part31_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
...
lemma part31_updates_opaque {st : State} : 
  Code.getReturn (part30_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part31_state_update (part30_drops (part30_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part30_state_update, part31_wp]

lemma part31_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
  ...
  Code.getReturn
      (part31_state_update
        (((((((((((((((((({
            ...
            if code0 - (16 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%65" : FeltVar }] ←
