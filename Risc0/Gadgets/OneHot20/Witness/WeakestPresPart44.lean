...
def part44_state (st: State) : State :=
        ...
        ((withEqZero
            ((st.felts { name := "%46" : FeltVar }).get! *
              ((st.felts { name := "%18" : FeltVar }).get! - (st.felts { name := "%46" : FeltVar }).get!))
            ((st[felts][{ name := "%107" : FeltVar }] ←
                (st.felts { name := "%18" : FeltVar }).get! -
                  (st.felts { name := "%46" : FeltVar }).get!)[felts][{ name := "%108" : FeltVar }] ←
              (st.felts { name := "%46" : FeltVar }).get! *
                ((st.felts { name := "%18" : FeltVar }).get! -
                  (st.felts { name := "%46" : FeltVar }).get!)))[felts][{ name := "%109" : FeltVar }] ←
          (st.felts { name := "%106" : FeltVar }).get! + (st.felts { name := "%46" : FeltVar }).get!) 
...
lemma part44_updates_opaque {st : State} : 
  ...
  try simp [part43_state_update, part44_wp]
