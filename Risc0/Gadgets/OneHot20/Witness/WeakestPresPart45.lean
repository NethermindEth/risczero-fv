...
def part45_state (st: State) : State :=
        ...
        ((withEqZero
            ((st.felts { name := "%49" : FeltVar }).get! *
              ((st.felts { name := "%18" : FeltVar }).get! - (st.felts { name := "%49" : FeltVar }).get!))
            ((st[felts][{ name := "%110" : FeltVar }] ←
                (st.felts { name := "%18" : FeltVar }).get! -
                  (st.felts { name := "%49" : FeltVar }).get!)[felts][{ name := "%111" : FeltVar }] ←
              (st.felts { name := "%49" : FeltVar }).get! *
                ((st.felts { name := "%18" : FeltVar }).get! -
                  (st.felts { name := "%49" : FeltVar }).get!)))[felts][{ name := "%112" : FeltVar }] ←
          (st.felts { name := "%109" : FeltVar }).get! + (st.felts { name := "%49" : FeltVar }).get!) 
...
lemma part45_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19 : Option Felt} :
  ...
  Code.getReturn (part45_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
...
lemma part45_updates_opaque {st : State} : 
  Code.getReturn (part44_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part45_state_update (part44_drops (part44_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part44_state_update, part45_wp]

lemma part45_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
  ...
  Code.getReturn
      (part45_state_update
        ({
            ...
            props := Map.empty,
            vars :=
              [{ name := "code" : BufferVar }, { name := "data" : BufferVar }] }[felts][{ name := "%109" : FeltVar }] ←
