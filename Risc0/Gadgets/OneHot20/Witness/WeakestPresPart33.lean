...
def part33_state (st: State) : State :=
        ...
        (withEqZero
          ((st.felts { name := "%72" : FeltVar }).get! +
              (st.felts { name := "%73" : FeltVar }).get! * (st.felts { name := "%0" : FeltVar }).get! -
            (st.felts { name := "%20" : FeltVar }).get!)
          (((st[felts][{ name := "%74" : FeltVar }] ←
                (st.felts { name := "%73" : FeltVar }).get! *
                  (st.felts { name := "%0" : FeltVar }).get!)[felts][{ name := "%75" : FeltVar }] ←
              (st.felts { name := "%72" : FeltVar }).get! +
                (st.felts { name := "%73" : FeltVar }).get! *
                  (st.felts { name := "%0" : FeltVar }).get!)[felts][{ name := "%76" : FeltVar }] ←
            (st.felts { name := "%72" : FeltVar }).get! +
                (st.felts { name := "%73" : FeltVar }).get! * (st.felts { name := "%0" : FeltVar }).get! -
              (st.felts { name := "%20" : FeltVar }).get!)) 
...
lemma part33_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19 : Option Felt} :
  ...
  Code.getReturn (part33_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
...
lemma part33_updates_opaque {st : State} : 
  Code.getReturn (part32_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part33_state_update (part32_drops (part32_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part32_state_update, part33_wp]

lemma part33_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
  ...
  Code.getReturn
      (part33_state_update
        (((((((((((((((((((({
                  ...
                  if code0 - (16 : Felt) = (0 : Felt) then (1 : Felt)
                  else (0 : Felt))[felts][{ name := "%67" : FeltVar }] ←
                if code0 - (17 : Felt) = (0 : Felt) then (1 : Felt)
                else (0 : Felt))[felts][{ name := "%70" : FeltVar }] ←
              if code0 - (18 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%72" : FeltVar }] ←
            (((((((((((((((((if code0 - (1 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt)) +
              ...
              else (0 : Felt))[felts][{ name := "%73" : FeltVar }] ←
