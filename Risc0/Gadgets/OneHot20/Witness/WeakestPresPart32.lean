...
def part32_state (st: State) : State :=
        ...
        ((((st["%70"] ←ₛ
              ...
              ((st["%70"] ←ₛ getImpl st { name := "data" : BufferVar } (0 : Back) (18 : ℕ)).felts
                    { name := "%70" : FeltVar }).get! *
                (st.felts { name := "%1" : FeltVar }).get!)[felts][{ name := "%72" : FeltVar }] ←
            (st.felts { name := "%69" : FeltVar }).get! +
              ((st["%70"] ←ₛ getImpl st { name := "data" : BufferVar } (0 : Back) (18 : ℕ)).felts
                    { name := "%70" : FeltVar }).get! *
                (st.felts { name := "%1" : FeltVar }).get!)["%73"] ←ₛ
...
lemma part32_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19 : Option Felt} :
  ...
  Code.getReturn (part32_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
...
lemma part32_updates_opaque {st : State} : 
  Code.getReturn (part31_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part32_state_update (part31_drops (part31_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part31_state_update, part32_wp]

lemma part32_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
  ...
  Code.getReturn
      (part32_state_update
        (((((((((((((((((({
              ...
              if code0 - (16 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%67" : FeltVar }] ←
            if code0 - (17 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%69" : FeltVar }] ←
