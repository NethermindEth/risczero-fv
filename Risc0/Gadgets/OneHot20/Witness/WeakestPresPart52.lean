...
def part52_state (st: State) : State :=
        ...
        ((withEqZero
            ((st.felts { name := "%70" : FeltVar }).get! *
              ((st.felts { name := "%18" : FeltVar }).get! - (st.felts { name := "%70" : FeltVar }).get!))
            ((st[felts][{ name := "%131" : FeltVar }] ←
                (st.felts { name := "%18" : FeltVar }).get! -
                  (st.felts { name := "%70" : FeltVar }).get!)[felts][{ name := "%132" : FeltVar }] ←
              (st.felts { name := "%70" : FeltVar }).get! *
                ((st.felts { name := "%18" : FeltVar }).get! -
                  (st.felts { name := "%70" : FeltVar }).get!)))[felts][{ name := "%133" : FeltVar }] ←
          (st.felts { name := "%130" : FeltVar }).get! + (st.felts { name := "%70" : FeltVar }).get!) 
...
lemma part52_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19 : Option Felt} :
  Code.getReturn (MLIR.runProgram (Code.part52;dropfelt ⟨"%70"⟩;dropfelt ⟨"%130"⟩;dropfelt ⟨"%131"⟩;dropfelt ⟨"%132"⟩;Code.part53;dropfelt ⟨"%73"⟩;dropfelt ⟨"%133"⟩;dropfelt ⟨"%134"⟩;dropfelt ⟨"%135"⟩;Code.part54;dropfelt ⟨"%18"⟩;dropfelt ⟨"%136"⟩;dropfelt ⟨"%137"⟩;dropfelt ⟨"%19"⟩) st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part52_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
...
lemma part52_updates_opaque {st : State} : 
  Code.getReturn (part51_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part52_state_update (part51_drops (part51_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part51_state_update, part52_wp]

lemma part52_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
  ...
  Code.getReturn
      (part52_state_update
        ({
            ...
            cycle := (0 : ℕ),
            felts :=
              ((Map.empty[{ name := "%18" : FeltVar }] ←ₘ (1 : Felt))[{ name := "%70" : FeltVar }] ←ₘ
            ...
            props := Map.empty,
            vars :=
              [{ name := "code" : BufferVar }, { name := "data" : BufferVar }] }[felts][{ name := "%130" : FeltVar }] ←
          (((((((((((((((((if code0 = (0 : Felt) then (1 : Felt) else (0 : Felt)) +
                                            if code0 - (1 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt)) +
