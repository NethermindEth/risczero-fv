...
def part52_state (st: State) : State :=
        ...
        ((withEqZero
            ...
            ((st[felts][{ name := "%131" : FeltVar }] ←
                Option.get! (State.felts st { name := "%18" : FeltVar }) -
                  Option.get! (State.felts st { name := "%70" : FeltVar }))[felts][{ name := "%132" : FeltVar }] ←
              Option.get! (State.felts st { name := "%70" : FeltVar }) *
                (Option.get! (State.felts st { name := "%18" : FeltVar }) -
                  Option.get! (State.felts st { name := "%70" : FeltVar }))))[felts][{ name := "%133" : FeltVar }] ←
          Option.get! (State.felts st { name := "%130" : FeltVar }) +
            Option.get! (State.felts st { name := "%70" : FeltVar })) 
