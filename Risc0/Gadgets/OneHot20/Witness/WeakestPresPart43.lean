...
def part43_state (st: State) : State :=
        ...
        ((withEqZero
            ((st.felts { name := "%43" : FeltVar }).get! *
              ((st.felts { name := "%18" : FeltVar }).get! - (st.felts { name := "%43" : FeltVar }).get!))
            ((st[felts][{ name := "%104" : FeltVar }] ←
                (st.felts { name := "%18" : FeltVar }).get! -
                  (st.felts { name := "%43" : FeltVar }).get!)[felts][{ name := "%105" : FeltVar }] ←
              (st.felts { name := "%43" : FeltVar }).get! *
                ((st.felts { name := "%18" : FeltVar }).get! -
                  (st.felts { name := "%43" : FeltVar }).get!)))[felts][{ name := "%106" : FeltVar }] ←
          (st.felts { name := "%103" : FeltVar }).get! + (st.felts { name := "%43" : FeltVar }).get!) 
...
lemma part43_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19 : Option Felt} :
  ...
  Code.getReturn (part43_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
...
lemma part43_updates_opaque {st : State} : 
  Code.getReturn (part42_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part43_state_update (part42_drops (part42_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part42_state_update, part43_wp]

lemma part43_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
  ...
  Code.getReturn
      (part43_state_update
        ({
            ...
            props := Map.empty,
            vars :=
              [{ name := "code" : BufferVar }, { name := "data" : BufferVar }] }[felts][{ name := "%103" : FeltVar }] ←
