...
def part27_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%50" : FeltVar }] ←
                (st.felts { name := "%49" : FeltVar }).get! *
                  (st.felts { name := "%8" : FeltVar }).get!)[felts][{ name := "%51" : FeltVar }] ←
              (st.felts { name := "%48" : FeltVar }).get! +
                (st.felts { name := "%49" : FeltVar }).get! * (st.felts { name := "%8" : FeltVar }).get!)["%52"] ←ₛ
          ...
          ((((st[felts][{ name := "%50" : FeltVar }] ←
                      ...
                      (st.felts { name := "%48" : FeltVar }).get! +
                        (st.felts { name := "%49" : FeltVar }).get! *
                          (st.felts { name := "%8" : FeltVar }).get!)["%52"] ←ₛ
...
lemma part27_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19 : Option Felt} :
  ...
  Code.getReturn (part27_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
...
lemma part27_updates_opaque {st : State} : 
  Code.getReturn (part26_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part27_state_update (part26_drops (part26_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part26_state_update, part27_wp]

lemma part27_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
  ...
  Code.getReturn
      (part27_state_update
        (((((((((((({
              ...
              if code0 - (10 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%48" : FeltVar }] ←
