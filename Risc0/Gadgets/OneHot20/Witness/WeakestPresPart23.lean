...
def part23_state (st: State) : State :=
        ...
        ((((st["%34"] ←ₛ
              ...
              ((st["%34"] ←ₛ getImpl st { name := "data" : BufferVar } (0 : Back) (6 : ℕ)).felts
                    { name := "%34" : FeltVar }).get! *
                (st.felts { name := "%13" : FeltVar }).get!)[felts][{ name := "%36" : FeltVar }] ←
            (st.felts { name := "%33" : FeltVar }).get! +
              ((st["%34"] ←ₛ getImpl st { name := "data" : BufferVar } (0 : Back) (6 : ℕ)).felts
                    { name := "%34" : FeltVar }).get! *
                (st.felts { name := "%13" : FeltVar }).get!)["%37"] ←ₛ
...
lemma part23_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19 : Option Felt} :
  ...
  Code.getReturn (part23_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
...
lemma part23_updates_opaque {st : State} : 
  Code.getReturn (part22_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part23_state_update (part22_drops (part22_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part22_state_update, part23_wp]

lemma part23_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
  ...
  Code.getReturn
      (part23_state_update
        (((((({
              ...
              if code0 - (4 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%31" : FeltVar }] ←
            if code0 - (5 : Felt) = (0 : Felt) then (1 : Felt) else (0 : Felt))[felts][{ name := "%33" : FeltVar }] ←
