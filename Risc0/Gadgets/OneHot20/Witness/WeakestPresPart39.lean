...
def part39_state (st: State) : State :=
          ...
          ((withEqZero
              ...
              ((st[felts][{ name := "%92" }] ←
                ...
                Option.get! (State.felts st { name := "%31" }) *
                  (Option.get! (State.felts st { name := "%18" }) -
                    Option.get! (State.felts st { name := "%31" }))))[felts][{ name := "%94" }] ←
            Option.get! (State.felts st { name := "%91" }) + Option.get! (State.felts st { name := "%31" })) 
  ...
  Code.getReturn
        (part39_state_update
          ({
              ...
              cycle := (0 : ℕ),
              felts :=
                (((((((((((((((Map.empty[{ name := "%18" }] ←ₘ (1 : Felt))[{ name := "%31" }] ←ₘ
              ...
              vars := [{ name := "code" }, { name := "data" }] }[felts][{ name := "%91" }] ←
