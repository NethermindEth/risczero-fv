...
def part39_state (st: State) : State :=
        ...
        ((withEqZero
            ((st.felts { name := "%31" : FeltVar }).get! *
              ((st.felts { name := "%18" : FeltVar }).get! - (st.felts { name := "%31" : FeltVar }).get!))
            ((st[felts][{ name := "%92" : FeltVar }] ←
                (st.felts { name := "%18" : FeltVar }).get! -
                  (st.felts { name := "%31" : FeltVar }).get!)[felts][{ name := "%93" : FeltVar }] ←
              (st.felts { name := "%31" : FeltVar }).get! *
                ((st.felts { name := "%18" : FeltVar }).get! -
                  (st.felts { name := "%31" : FeltVar }).get!)))[felts][{ name := "%94" : FeltVar }] ←
          (st.felts { name := "%91" : FeltVar }).get! + (st.felts { name := "%31" : FeltVar }).get!) 
...
lemma part39_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19 : Option Felt} :
  ...
  Code.getReturn (part39_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
...
lemma part39_updates_opaque {st : State} : 
  Code.getReturn (part38_state_update st) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) ↔
  Code.getReturn (part39_state_update (part38_drops (part38_state st))) ([data0, data1, data2, data3, data4, data5, data6, data7, data8, data9, data10, data11, data12, data13, data14, data15, data16, data17, data18, data19]) := by
  try simp [part38_state_update, part39_wp]

lemma part39_cumulative_wp {code0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Option Felt} :
