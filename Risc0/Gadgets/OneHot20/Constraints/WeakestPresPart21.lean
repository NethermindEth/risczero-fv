...
def part21_state (st: State) : State :=
        ...
        ((((st[props][{ name := "%84" }] ←
                (Option.get! (State.props st { name := "%81" }) ∧
                  Option.get! (State.felts st { name := "%83" }) = (0 : Felt)))[felts][{ name := "%85" }] ←
          ...
          Option.get! (State.felts st { name := "%22" }) *
            (Option.get! (State.felts st { name := "%0" }) - Option.get! (State.felts st { name := "%22" }))) 
      ...
      (part21_state_update
        ((((((((((((((((((((((((({
            ...
            (y1 + y2 * (2 : Felt) + y3 * (3 : Felt) + y4 * (4 : Felt) + y5 * (5 : Felt) + y6 * (6 : Felt) +
                  ...
                  x0 =
                (0 : Felt) ∧
              (y0 = (0 : Felt) ∨ (1 : Felt) - y0 = (0 : Felt))))[felts][{ name := "%83" }] ←
          y1 * ((1 : Felt) - y1)))  := by
