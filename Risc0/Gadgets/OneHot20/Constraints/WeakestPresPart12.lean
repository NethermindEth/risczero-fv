...
def part12_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%56" : FeltVar }] ←
                (st.felts { name := "%55" : FeltVar }).get! *
                  (st.felts { name := "%12" : FeltVar }).get!)[felts][{ name := "%57" : FeltVar }] ←
              (st.felts { name := "%54" : FeltVar }).get! +
                (st.felts { name := "%55" : FeltVar }).get! *
                  (st.felts { name := "%12" : FeltVar }).get!)[felts][{ name := "%13" : FeltVar }] ←
            (14 : Felt))["%58"] ←ₛ
...
lemma part12_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
      ...
      (part12_state_update
        (((((((((((((((({
              ...
              data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) + data5 * (5 : Felt) +
                    ...
                    data10 * (10 : Felt) +
                  data11 * (11 : Felt) +
                data12 * (12 : Felt))[felts][{ name := "%12" : FeltVar }] ←
