...
def part29_state (st: State) : State :=
        ...
        ((((st[props][{ name := "%116" : PropVar }] ←
                ((st.props { name := "%112" : PropVar }).get! ∧
                  (st.felts { name := "%115" : FeltVar }).get! = (0 : Felt)))[felts][{ name := "%117" : FeltVar }] ←
              (st.felts { name := "%113" : FeltVar }).get! +
                (st.felts { name := "%43" : FeltVar }).get!)[felts][{ name := "%118" : FeltVar }] ←
            (st.felts { name := "%0" : FeltVar }).get! -
              (st.felts { name := "%46" : FeltVar }).get!)[felts][{ name := "%119" : FeltVar }] ←
          (st.felts { name := "%46" : FeltVar }).get! *
            ((st.felts { name := "%0" : FeltVar }).get! - (st.felts { name := "%46" : FeltVar }).get!)) 
...
lemma part29_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
      ...
      (part29_state_update
        ((((((((((((((((((((((((({
              ...
              (((((((((data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) + data5 * (5 : Felt) +
                ...
                (data8 = (0 : Felt) ∨ (1 : Felt) - data8 = (0 : Felt))))[felts][{ name := "%113" : FeltVar }] ←
            data0 + data1 + data2 + data3 + data4 + data5 + data6 + data7 +
              data8)[felts][{ name := "%115" : FeltVar }] ←
          data9 * ((1 : Felt) - data9)))  := by
