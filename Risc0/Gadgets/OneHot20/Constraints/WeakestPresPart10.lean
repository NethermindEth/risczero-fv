...
lemma part10_cumulative_wp {x0 y0 y1 y2 y3 y4 y5 y6 y7 y8 y9 y10 y11 y12 y13 y14 y15 y16 y17 y18 y19: Felt} :
  ...
  Code.getReturn
      (part10_state_update
        (((((((((((((({
                ...
                y10)[felts][{ name := "%48" : FeltVar }] ←
              y1 + y2 * (2 : Felt) + y3 * (3 : Felt) + y4 * (4 : Felt) + y5 * (5 : Felt) + y6 * (6 : Felt) +
                      y7 * (7 : Felt) +
                    y8 * (8 : Felt) +
                  y9 * (9 : Felt) +
                y10 * (10 : Felt))[felts][{ name := "%10" : FeltVar }] ←
