...
def part35_state (st: State) : State :=
        ...
        ((((st[props][{ name := "%140" }] ←
                (Option.get! (State.props st { name := "%136" }) ∧
                  Option.get! (State.felts st { name := "%139" }) = (0 : Felt)))[felts][{ name := "%141" }] ←
              Option.get! (State.felts st { name := "%137" }) +
                Option.get! (State.felts st { name := "%61" }))[felts][{ name := "%142" }] ←
            Option.get! (State.felts st { name := "%0" }) -
              Option.get! (State.felts st { name := "%64" }))[felts][{ name := "%143" }] ←
          Option.get! (State.felts st { name := "%64" }) *
            (Option.get! (State.felts st { name := "%0" }) - Option.get! (State.felts st { name := "%64" }))) 
      ...
      (part35_state_update
        ((((((((((((((((((((((((({
              ...
              (((((((((((((((y1 + y2 * (2 : Felt) + y3 * (3 : Felt) + y4 * (4 : Felt) + y5 * (5 : Felt) +
                ...
                (y14 = (0 : Felt) ∨ (1 : Felt) - y14 = (0 : Felt))))[felts][{ name := "%137" }] ←
            y0 + y1 + y2 + y3 + y4 + y5 + y6 + y7 + y8 + y9 + y10 + y11 + y12 + y13 + y14)[felts][{ name := "%139" }] ←
          y15 * ((1 : Felt) - y15)))  := by
