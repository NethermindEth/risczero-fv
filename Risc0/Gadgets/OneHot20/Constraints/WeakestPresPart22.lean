...
lemma part22_updates_opaque {st : State} : 
  ...
  Code.getReturn (part22_state_update (part21_drops (part21_state st))) := by
  try simp [part21_state_update, part22_wp]

lemma part22_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
      ...
      (part22_state_update
        ((((((((((((((((((((((((({
              ...
              ((data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) + data5 * (5 : Felt) +
                ...
                (data1 = (0 : Felt) ∨ (1 : Felt) - data1 = (0 : Felt))))[felts][{ name := "%85" : FeltVar }] ←
            data0 + data1)[felts][{ name := "%87" : FeltVar }] ←
          data2 * ((1 : Felt) - data2)))  := by
