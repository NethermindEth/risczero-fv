...
def part22_state (st: State) : State :=
        ...
        ((((st[props][{ name := "%88" }] ←
                (Option.get! (State.props st { name := "%84" }) ∧
                  Option.get! (State.felts st { name := "%87" }) = (0 : Felt)))[felts][{ name := "%89" }] ←
          ...
          Option.get! (State.felts st { name := "%25" }) *
            (Option.get! (State.felts st { name := "%0" }) - Option.get! (State.felts st { name := "%25" }))) 
      ...
      (part22_state_update
        ((((((((((((((((((((((((({
              ...
              ((y1 + y2 * (2 : Felt) + y3 * (3 : Felt) + y4 * (4 : Felt) + y5 * (5 : Felt) + y6 * (6 : Felt) +
                ...
                (y1 = (0 : Felt) ∨ (1 : Felt) - y1 = (0 : Felt))))[felts][{ name := "%85" }] ←
            y0 + y1)[felts][{ name := "%87" }] ←
          y2 * ((1 : Felt) - y2)))  := by
