...
lemma part14_cumulative_wp {x0 y0 y1 y2 y3 y4 y5 y6 y7 y8 y9 y10 y11 y12 y13 y14 y15 y16 y17 y18 y19: Felt} :
      ...
      (part14_state_update
        (((((((((((((((((({
                                              buffers :=
                                                ((fun x => Map.empty x)[{ name := "data" : BufferVar }] ←ₘ
                                                    [[some y0, some y1, some y2, some y3, some y4, some y5, some y6,
                                                        some y7, some y8, some y9, some y10, some y11, some y12,
                                                        some y13, some y14, some y15, some y16, some y17, some y18,
              ...
              y1 + y2 * (2 : Felt) + y3 * (3 : Felt) + y4 * (4 : Felt) + y5 * (5 : Felt) + y6 * (6 : Felt) +
                    ...
                    y12 * (12 : Felt) +
                  y13 * (13 : Felt) +
                y14 * (14 : Felt))[felts][{ name := "%14" : FeltVar }] ←
            (15 : Felt))[felts][{ name := "%61" : FeltVar }] ←
          y15))  := by
