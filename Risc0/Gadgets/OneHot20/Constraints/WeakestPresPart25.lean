...
def part25_state (st: State) : State :=
        ...
        ((((st[props][{ name := "%100" }] ←
                (Option.get! (State.props st { name := "%96" }) ∧
                  Option.get! (State.felts st { name := "%99" }) = (0 : Felt)))[felts][{ name := "%101" }] ←
              Option.get! (State.felts st { name := "%97" }) +
                Option.get! (State.felts st { name := "%31" }))[felts][{ name := "%102" }] ←
            Option.get! (State.felts st { name := "%0" }) -
              Option.get! (State.felts st { name := "%34" }))[felts][{ name := "%103" }] ←
          Option.get! (State.felts st { name := "%34" }) *
            (Option.get! (State.felts st { name := "%0" }) - Option.get! (State.felts st { name := "%34" }))) 
      ...
      (part25_state_update
        ((((((((((((((((((((((((({
              ...
              (((((y1 + y2 * (2 : Felt) + y3 * (3 : Felt) + y4 * (4 : Felt) + y5 * (5 : Felt) + y6 * (6 : Felt) +
                ...
                (y4 = (0 : Felt) ∨ (1 : Felt) - y4 = (0 : Felt))))[felts][{ name := "%97" }] ←
            y0 + y1 + y2 + y3 + y4)[felts][{ name := "%99" }] ←
          y5 * ((1 : Felt) - y5)))  := by
