...
def part7_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%41" }] ←
              ...
              Option.get! (State.felts st { name := "%39" }) +
                Option.get! (State.felts st { name := "%40" }) *
                  Option.get! (State.felts st { name := "%7" }))[felts][{ name := "%8" }] ←
            (9 : Felt))["%43"] ←ₛ
...
lemma part7_cumulative_wp {x0 y0 y1 y2 y3 y4 y5 y6 y7 y8 y9 y10 y11 y12 y13 y14 y15 y16 y17 y18 y19: Felt} :
      ...
      (part7_state_update
        ((((((((((({
              ...
              y1 + y2 * (2 : Felt) + y3 * (3 : Felt) + y4 * (4 : Felt) + y5 * (5 : Felt) + y6 * (6 : Felt) +
                y7 * (7 : Felt))[felts][{ name := "%7" }] ←
            (8 : Felt))[felts][{ name := "%40" }] ←
          y8))  := by
