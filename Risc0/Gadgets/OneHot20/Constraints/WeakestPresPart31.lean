...
def part31_state (st: State) : State :=
        ...
        ((((st[props][{ name := "%124" : PropVar }] ←
                (Option.get! (State.props st { name := "%120" : PropVar }) ∧
                  Option.get! (State.felts st { name := "%123" : FeltVar }) =
                    (0 : Felt)))[felts][{ name := "%125" : FeltVar }] ←
              Option.get! (State.felts st { name := "%121" : FeltVar }) +
                Option.get! (State.felts st { name := "%49" : FeltVar }))[felts][{ name := "%126" : FeltVar }] ←
            Option.get! (State.felts st { name := "%0" : FeltVar }) -
              Option.get! (State.felts st { name := "%52" : FeltVar }))[felts][{ name := "%127" : FeltVar }] ←
      ...
      (part31_state_update
        ((((((((((((((((((((((((({
              ...
              (((((((((((y1 + y2 * (2 : Felt) + y3 * (3 : Felt) + y4 * (4 : Felt) + y5 * (5 : Felt) + y6 * (6 : Felt) +
                ...
                (y10 = (0 : Felt) ∨ (1 : Felt) - y10 = (0 : Felt))))[felts][{ name := "%121" : FeltVar }] ←
            y0 + y1 + y2 + y3 + y4 + y5 + y6 + y7 + y8 + y9 + y10)[felts][{ name := "%123" : FeltVar }] ←
          y11 * ((1 : Felt) - y11)))  := by
