...
def part17_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%71" : FeltVar }] ←
                (st.felts { name := "%70" : FeltVar }).get! *
                  (st.felts { name := "%17" : FeltVar }).get!)[felts][{ name := "%72" : FeltVar }] ←
              (st.felts { name := "%69" : FeltVar }).get! +
                (st.felts { name := "%70" : FeltVar }).get! *
                  (st.felts { name := "%17" : FeltVar }).get!)[felts][{ name := "%18" : FeltVar }] ←
            (19 : Felt))["%73"] ←ₛ
...
lemma part17_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
      ...
      (part17_state_update
        ((((((((((((((((((((({
              ...
              data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) + data5 * (5 : Felt) +
                    ...
                    data15 * (15 : Felt) +
                  data16 * (16 : Felt) +
                data17 * (17 : Felt))[felts][{ name := "%17" : FeltVar }] ←
