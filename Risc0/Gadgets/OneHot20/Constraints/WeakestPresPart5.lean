...
lemma part5_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
  ...
  Code.getReturn
      (part5_state_update
        ((((((((({
                ...
                data5)[felts][{ name := "%33" : FeltVar }] ←
              data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) +
                data5 * (5 : Felt))[felts][{ name := "%5" : FeltVar }] ←
            (6 : Felt))[felts][{ name := "%34" : FeltVar }] ←
          data6))  := by
