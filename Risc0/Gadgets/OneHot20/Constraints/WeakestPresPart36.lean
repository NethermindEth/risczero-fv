...
def part36_state (st: State) : State :=
        ...
        ((((st[props][{ name := "%144" : PropVar }] ←
                ((st.props { name := "%140" : PropVar }).get! ∧
                  (st.felts { name := "%143" : FeltVar }).get! = (0 : Felt)))[felts][{ name := "%145" : FeltVar }] ←
              (st.felts { name := "%141" : FeltVar }).get! +
                (st.felts { name := "%64" : FeltVar }).get!)[felts][{ name := "%146" : FeltVar }] ←
            (st.felts { name := "%0" : FeltVar }).get! -
              (st.felts { name := "%67" : FeltVar }).get!)[felts][{ name := "%147" : FeltVar }] ←
          (st.felts { name := "%67" : FeltVar }).get! *
            ((st.felts { name := "%0" : FeltVar }).get! - (st.felts { name := "%67" : FeltVar }).get!)) 
...
def part36_state_update (st: State): State :=
  Γ (part36_drops (part36_state st)) ⟦Code.part37;dropfelt ⟨"%67"⟩;dropfelt ⟨"%145"⟩;dropfelt ⟨"%147"⟩;dropfelt ⟨"%150"⟩;Code.part38;dropfelt ⟨"%70"⟩;dropfelt ⟨"%149"⟩;dropfelt ⟨"%151"⟩;dropfelt ⟨"%154"⟩;Code.part39;dropfelt ⟨"%73"⟩;dropfelt ⟨"%0"⟩;dropfelt ⟨"%153"⟩;dropfelt ⟨"%155"⟩;dropfelt ⟨"%157"⟩;dropfelt ⟨"%158"⟩⟧
...
lemma part36_wp {st : State} :
  ...
  generalize eq : (dropfelt ⟨"%64"⟩;dropfelt ⟨"%141"⟩;dropfelt ⟨"%143"⟩;dropfelt ⟨"%146"⟩;Code.part37;dropfelt ⟨"%67"⟩;dropfelt ⟨"%145"⟩;dropfelt ⟨"%147"⟩;dropfelt ⟨"%150"⟩;Code.part38;dropfelt ⟨"%70"⟩;dropfelt ⟨"%149"⟩;dropfelt ⟨"%151"⟩;dropfelt ⟨"%154"⟩;Code.part39;dropfelt ⟨"%73"⟩;dropfelt ⟨"%0"⟩;dropfelt ⟨"%153"⟩;dropfelt ⟨"%155"⟩;dropfelt ⟨"%157"⟩;dropfelt ⟨"%158"⟩) = prog
  unfold Code.part36
  MLIR
  rewrite [←eq]
...
lemma part36_updates_opaque {st : State} : 
  ...
  try simp [part35_state_update, part36_wp]

lemma part36_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
      ...
      (part36_state_update
        ((((((((((((((((((((((((({
              ...
              ((((((((((((((((data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) +
                ...
                (data15 = (0 : Felt) ∨ (1 : Felt) - data15 = (0 : Felt))))[felts][{ name := "%141" : FeltVar }] ←
            data0 + data1 + data2 + data3 + data4 + data5 + data6 + data7 + data8 + data9 + data10 + data11 + data12 +
                  data13 +
                data14 +
              data15)[felts][{ name := "%143" : FeltVar }] ←
          data16 * ((1 : Felt) - data16)))  := by
