...
def part28_state (st: State) : State :=
        ...
        ((((st[props][{ name := "%112" : PropVar }] ←
                ((st.props { name := "%108" : PropVar }).get! ∧
                  (st.felts { name := "%111" : FeltVar }).get! = (0 : Felt)))[felts][{ name := "%113" : FeltVar }] ←
              (st.felts { name := "%109" : FeltVar }).get! +
                (st.felts { name := "%40" : FeltVar }).get!)[felts][{ name := "%114" : FeltVar }] ←
            (st.felts { name := "%0" : FeltVar }).get! -
              (st.felts { name := "%43" : FeltVar }).get!)[felts][{ name := "%115" : FeltVar }] ←
          (st.felts { name := "%43" : FeltVar }).get! *
            ((st.felts { name := "%0" : FeltVar }).get! - (st.felts { name := "%43" : FeltVar }).get!)) 
...
lemma part28_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
      ...
      (part28_state_update
        ((((((((((((((((((((((((({
              ...
              ((((((((data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) + data5 * (5 : Felt) +
                ...
                (data7 = (0 : Felt) ∨ (1 : Felt) - data7 = (0 : Felt))))[felts][{ name := "%109" : FeltVar }] ←
            data0 + data1 + data2 + data3 + data4 + data5 + data6 + data7)[felts][{ name := "%111" : FeltVar }] ←
          data8 * ((1 : Felt) - data8)))  := by
