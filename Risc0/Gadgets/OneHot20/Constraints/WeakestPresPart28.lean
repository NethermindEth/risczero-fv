...
def part28_state (st: State) : State :=
        ...
        ((((st[props][{ name := "%112" }] ←
                (Option.get! (State.props st { name := "%108" }) ∧
                  Option.get! (State.felts st { name := "%111" }) = (0 : Felt)))[felts][{ name := "%113" }] ←
          ...
          Option.get! (State.felts st { name := "%43" }) *
            (Option.get! (State.felts st { name := "%0" }) - Option.get! (State.felts st { name := "%43" }))) 
      ...
      (part28_state_update
        ((((((((((((((((((((((((({
              ...
              ((((((((y1 + y2 * (2 : Felt) + y3 * (3 : Felt) + y4 * (4 : Felt) + y5 * (5 : Felt) + y6 * (6 : Felt) +
                ...
                (y7 = (0 : Felt) ∨ (1 : Felt) - y7 = (0 : Felt))))[felts][{ name := "%109" }] ←
            y0 + y1 + y2 + y3 + y4 + y5 + y6 + y7)[felts][{ name := "%111" }] ←
          y8 * ((1 : Felt) - y8)))  := by
