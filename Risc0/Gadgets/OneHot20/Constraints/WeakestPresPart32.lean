...
def part32_state (st: State) : State :=
        ...
        ((((st[props][{ name := "%128" }] ←
                (Option.get! (State.props st { name := "%124" }) ∧
                  Option.get! (State.felts st { name := "%127" }) = (0 : Felt)))[felts][{ name := "%129" }] ←
          ...
          Option.get! (State.felts st { name := "%55" }) *
            (Option.get! (State.felts st { name := "%0" }) - Option.get! (State.felts st { name := "%55" }))) 
      ...
      (part32_state_update
        ((((((((((((((((((((((((({
              ...
              ((((((((((((y1 + y2 * (2 : Felt) + y3 * (3 : Felt) + y4 * (4 : Felt) + y5 * (5 : Felt) + y6 * (6 : Felt) +
                ...
                (y11 = (0 : Felt) ∨ (1 : Felt) - y11 = (0 : Felt))))[felts][{ name := "%125" }] ←
            y0 + y1 + y2 + y3 + y4 + y5 + y6 + y7 + y8 + y9 + y10 + y11)[felts][{ name := "%127" }] ←
          y12 * ((1 : Felt) - y12)))  := by
