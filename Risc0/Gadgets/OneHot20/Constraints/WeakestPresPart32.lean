...
def part32_state (st: State) : State :=
        ...
        ((((st[props][{ name := "%128" : PropVar }] ←
                ((st.props { name := "%124" : PropVar }).get! ∧
                  (st.felts { name := "%127" : FeltVar }).get! = (0 : Felt)))[felts][{ name := "%129" : FeltVar }] ←
              (st.felts { name := "%125" : FeltVar }).get! +
                (st.felts { name := "%52" : FeltVar }).get!)[felts][{ name := "%130" : FeltVar }] ←
            (st.felts { name := "%0" : FeltVar }).get! -
              (st.felts { name := "%55" : FeltVar }).get!)[felts][{ name := "%131" : FeltVar }] ←
          (st.felts { name := "%55" : FeltVar }).get! *
            ((st.felts { name := "%0" : FeltVar }).get! - (st.felts { name := "%55" : FeltVar }).get!)) 
...
lemma part32_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
      ...
      (part32_state_update
        ((((((((((((((((((((((((({
              ...
              ((((((((((((data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) + data5 * (5 : Felt) +
                ...
                (data11 = (0 : Felt) ∨ (1 : Felt) - data11 = (0 : Felt))))[felts][{ name := "%125" : FeltVar }] ←
            data0 + data1 + data2 + data3 + data4 + data5 + data6 + data7 + data8 + data9 + data10 +
              data11)[felts][{ name := "%127" : FeltVar }] ←
          data12 * ((1 : Felt) - data12)))  := by
