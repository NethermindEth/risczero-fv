...
lemma part27_updates_opaque {st : State} : 
  ...
  Code.getReturn (part27_state_update (part26_drops (part26_state st))) := by
  try simp [part26_state_update, part27_wp]

lemma part27_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
      ...
      (part27_state_update
        ((((((((((((((((((((((((({
                    ...
                    ((((data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) + data5 * (5 : Felt) +
                      ...
                      (data3 = (0 : Felt) ∨ (1 : Felt) - data3 = (0 : Felt))))[props][{ name := "%96" : PropVar }] ←
                  (((((data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) + data5 * (5 : Felt) +
                                                            data6 * (6 : Felt) +
                                                          data7 * (7 : Felt) +
                                                        data8 * (8 : Felt) +
                    ...
                    (data4 = (0 : Felt) ∨ (1 : Felt) - data4 = (0 : Felt))))[props][{ name := "%100" : PropVar }] ←
                ((((((data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) + data5 * (5 : Felt) +
                                                            data6 * (6 : Felt) +
                                                          data7 * (7 : Felt) +
                                                        data8 * (8 : Felt) +
                  ...
                  (data5 = (0 : Felt) ∨ (1 : Felt) - data5 = (0 : Felt))))[props][{ name := "%104" : PropVar }] ←
              (((((((data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) + data5 * (5 : Felt) +
                                                            data6 * (6 : Felt) +
                                                          data7 * (7 : Felt) +
                                                        data8 * (8 : Felt) +
                ...
                (data6 = (0 : Felt) ∨ (1 : Felt) - data6 = (0 : Felt))))[felts][{ name := "%105" : FeltVar }] ←
            data0 + data1 + data2 + data3 + data4 + data5 + data6)[felts][{ name := "%107" : FeltVar }] ←
          data7 * ((1 : Felt) - data7)))  := by
