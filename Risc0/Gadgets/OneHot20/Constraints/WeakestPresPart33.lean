...
lemma part33_updates_opaque {st : State} : 
  ...
  Code.getReturn (part33_state_update (part32_drops (part32_state st))) := by
  try simp [part32_state_update, part33_wp]

lemma part33_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
      ...
      (part33_state_update
        ((((((((((((((((((((((((({
              ...
              (((((((((((((data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) + data5 * (5 : Felt) +
                ...
                (data12 = (0 : Felt) ∨ (1 : Felt) - data12 = (0 : Felt))))[felts][{ name := "%129" : FeltVar }] ←
            data0 + data1 + data2 + data3 + data4 + data5 + data6 + data7 + data8 + data9 + data10 + data11 +
              data12)[felts][{ name := "%131" : FeltVar }] ←
          data13 * ((1 : Felt) - data13)))  := by
