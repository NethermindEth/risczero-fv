...
lemma part20_updates_opaque {st : State} : 
  ...
  Code.getReturn (part20_state_update (part19_drops (part19_state st))) := by
  try simp [part19_state_update, part20_wp]

lemma part20_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
  ...
  Code.getReturn
      (part20_state_update
        (((((((((((((((((((((((({
              ...
              (1 : Felt))[felts][{ name := "%78" : FeltVar }] ←
            data0)[felts][{ name := "%79" : FeltVar }] ←
          (1 : Felt) - data0))  := by
