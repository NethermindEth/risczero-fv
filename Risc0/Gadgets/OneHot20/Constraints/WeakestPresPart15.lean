...
def part15_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%65" : FeltVar }] ←
                Option.get! (State.felts st { name := "%64" : FeltVar }) *
                  Option.get! (State.felts st { name := "%15" : FeltVar }))[felts][{ name := "%66" : FeltVar }] ←
              Option.get! (State.felts st { name := "%63" : FeltVar }) +
                Option.get! (State.felts st { name := "%64" : FeltVar }) *
                  Option.get! (State.felts st { name := "%15" : FeltVar }))[felts][{ name := "%16" : FeltVar }] ←
            (17 : Felt))["%67"] ←ₛ
...
lemma part15_cumulative_wp {x0 y0 y1 y2 y3 y4 y5 y6 y7 y8 y9 y10 y11 y12 y13 y14 y15 y16 y17 y18 y19: Felt} :
      ...
      (part15_state_update
        ((((((((((((((((((({
              ...
              y1 + y2 * (2 : Felt) + y3 * (3 : Felt) + y4 * (4 : Felt) + y5 * (5 : Felt) + y6 * (6 : Felt) +
                    ...
                    y13 * (13 : Felt) +
                  y14 * (14 : Felt) +
                y15 * (15 : Felt))[felts][{ name := "%15" : FeltVar }] ←
