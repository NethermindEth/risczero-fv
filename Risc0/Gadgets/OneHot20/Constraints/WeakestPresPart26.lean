...
def part26_state (st: State) : State :=
        ...
        ((((st[props][{ name := "%104" : PropVar }] ←
                ((st.props { name := "%100" : PropVar }).get! ∧
                  (st.felts { name := "%103" : FeltVar }).get! = (0 : Felt)))[felts][{ name := "%105" : FeltVar }] ←
              (st.felts { name := "%101" : FeltVar }).get! +
                (st.felts { name := "%34" : FeltVar }).get!)[felts][{ name := "%106" : FeltVar }] ←
            (st.felts { name := "%0" : FeltVar }).get! -
              (st.felts { name := "%37" : FeltVar }).get!)[felts][{ name := "%107" : FeltVar }] ←
          (st.felts { name := "%37" : FeltVar }).get! *
            ((st.felts { name := "%0" : FeltVar }).get! - (st.felts { name := "%37" : FeltVar }).get!)) 
...
lemma part26_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
      ...
      (part26_state_update
        ((((((((((((((((((((((((({
              ...
              ((((((data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) + data5 * (5 : Felt) +
                ...
                (data5 = (0 : Felt) ∨ (1 : Felt) - data5 = (0 : Felt))))[felts][{ name := "%101" : FeltVar }] ←
            data0 + data1 + data2 + data3 + data4 + data5)[felts][{ name := "%103" : FeltVar }] ←
          data6 * ((1 : Felt) - data6)))  := by
