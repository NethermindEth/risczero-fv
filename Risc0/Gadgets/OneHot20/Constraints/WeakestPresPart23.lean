...
def part23_state (st: State) : State :=
        ...
        ((((st[props][{ name := "%92" : PropVar }] ←
                ((st.props { name := "%88" : PropVar }).get! ∧
                  (st.felts { name := "%91" : FeltVar }).get! = (0 : Felt)))[felts][{ name := "%93" : FeltVar }] ←
              (st.felts { name := "%89" : FeltVar }).get! +
                (st.felts { name := "%25" : FeltVar }).get!)[felts][{ name := "%94" : FeltVar }] ←
            (st.felts { name := "%0" : FeltVar }).get! -
              (st.felts { name := "%28" : FeltVar }).get!)[felts][{ name := "%95" : FeltVar }] ←
          (st.felts { name := "%28" : FeltVar }).get! *
            ((st.felts { name := "%0" : FeltVar }).get! - (st.felts { name := "%28" : FeltVar }).get!)) 
...
lemma part23_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
      ...
      (part23_state_update
        ((((((((((((((((((((((((({
              ...
              (((data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt) + data5 * (5 : Felt) +
                ...
                (data2 = (0 : Felt) ∨ (1 : Felt) - data2 = (0 : Felt))))[felts][{ name := "%89" : FeltVar }] ←
            data0 + data1 + data2)[felts][{ name := "%91" : FeltVar }] ←
          data3 * ((1 : Felt) - data3)))  := by
