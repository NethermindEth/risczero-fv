...
lemma part4_cumulative_wp {code0 data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 data18 data19: Felt} :
  ...
  Code.getReturn
      (part4_state_update
        (((((((({
                ...
                data4)[felts][{ name := "%30" : FeltVar }] ←
              data1 + data2 * (2 : Felt) + data3 * (3 : Felt) + data4 * (4 : Felt))[felts][{ name := "%4" : FeltVar }] ←
            (5 : Felt))[felts][{ name := "%31" : FeltVar }] ←
          data5))  := by
