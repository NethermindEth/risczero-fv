...
def part16_state (st: State) : State :=
        ...
        ((((st[felts][{ name := "%68" }] ←
              ...
              Option.get! (State.felts st { name := "%66" }) +
                Option.get! (State.felts st { name := "%67" }) *
                  Option.get! (State.felts st { name := "%16" }))[felts][{ name := "%17" }] ←
            (18 : Felt))["%70"] ←ₛ
          getImpl st { name := "data" } (0 : Back) (18 : ℕ)) 
...
lemma part16_cumulative_wp {x0 y0 y1 y2 y3 y4 y5 y6 y7 y8 y9 y10 y11 y12 y13 y14 y15 y16 y17 y18 y19: Felt} :
      ...
      (part16_state_update
        (((((((((((((((((((({
              ...
              y1 + y2 * (2 : Felt) + y3 * (3 : Felt) + y4 * (4 : Felt) + y5 * (5 : Felt) + y6 * (6 : Felt) +
                    ...
                    y14 * (14 : Felt) +
                  y15 * (15 : Felt) +
                y16 * (16 : Felt))[felts][{ name := "%16" }] ←
            (17 : Felt))[felts][{ name := "%67" }] ←
          y17))  := by
