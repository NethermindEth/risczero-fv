...
def part18_state (st: State) : State :=
        ...
        ((withEqZero
            ((st.felts { name := "%7" : FeltVar }).get! -
              ((st.felts { name := "%51" : FeltVar }).get! + (st.felts { name := "%40" : FeltVar }).get!))
            ((st[felts][{ name := "%52" : FeltVar }] ←
                (st.felts { name := "%51" : FeltVar }).get! +
                  (st.felts { name := "%40" : FeltVar }).get!)[felts][{ name := "%53" : FeltVar }] ←
              (st.felts { name := "%7" : FeltVar }).get! -
                ((st.felts { name := "%51" : FeltVar }).get! + (st.felts { name := "%40" : FeltVar }).get!)))["%55"] ←ₛ
