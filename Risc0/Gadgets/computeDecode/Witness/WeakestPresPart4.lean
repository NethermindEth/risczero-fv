...
def part4_state (st: State) : State :=
        ...
        (State.set!
          (State.set!
            (State.set!
              (State.set! st { name := "data" : BufferVar } (5 : ℕ) (Option.get! st.felts[{ name := "%3" : FeltVar }]!))
              { name := "data" : BufferVar } (7 : ℕ) (Option.get! st.felts[{ name := "%3" : FeltVar }]!))
            { name := "data" : BufferVar } (6 : ℕ) (Option.get! st.felts[{ name := "%7" : FeltVar }]!))
          { name := "data" : BufferVar } (16 : ℕ) (Option.get! st.felts[{ name := "%3" : FeltVar }]!)) 
...
lemma part4_wp {st : State} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17 : Option Felt} :
  ...
  generalize eq : (dropfelt ⟨"%3"⟩;Code.part5;Code.part6;dropfelt ⟨"%11"⟩;dropfelt ⟨"%13"⟩;Code.part7;dropfelt ⟨"%14"⟩;dropfelt ⟨"%15"⟩;dropfelt ⟨"%16"⟩;Code.part8;dropfelt ⟨"%12"⟩;dropfelt ⟨"%17"⟩;dropfelt ⟨"%18"⟩;dropfelt ⟨"%10"⟩;Code.part9;dropfelt ⟨"%19"⟩;dropfelt ⟨"%0"⟩;dropfelt ⟨"%20"⟩;dropfelt ⟨"%21"⟩;dropfelt ⟨"%22"⟩;Code.part10;dropfelt ⟨"%23"⟩;dropfelt ⟨"%9"⟩;dropfelt ⟨"%24"⟩;dropfelt ⟨"%25"⟩;Code.part11;dropfelt ⟨"%27"⟩;dropfelt ⟨"%30"⟩;Code.part12;dropfelt ⟨"%1"⟩;dropfelt ⟨"%31"⟩;dropfelt ⟨"%32"⟩;dropfelt ⟨"%33"⟩;Code.part13;dropfelt ⟨"%28"⟩;dropfelt ⟨"%34"⟩;dropfelt ⟨"%29"⟩;dropfelt ⟨"%35"⟩;dropfelt ⟨"%36"⟩;Code.part14;dropfelt ⟨"%6"⟩;dropfelt ⟨"%37"⟩;dropfelt ⟨"%26"⟩;dropfelt ⟨"%38"⟩;dropfelt ⟨"%39"⟩;Code.part15;dropfelt ⟨"%5"⟩;dropfelt ⟨"%41"⟩;dropfelt ⟨"%44"⟩;Code.part16;dropfelt ⟨"%2"⟩;dropfelt ⟨"%45"⟩;dropfelt ⟨"%43"⟩;dropfelt ⟨"%46"⟩;Code.part17;dropfelt ⟨"%42"⟩;dropfelt ⟨"%47"⟩;dropfelt ⟨"%48"⟩;dropfelt ⟨"%49"⟩;dropfelt ⟨"%50"⟩;Code.part18;dropfelt ⟨"%7"⟩;dropfelt ⟨"%51"⟩;dropfelt ⟨"%40"⟩;dropfelt ⟨"%52"⟩;dropfelt ⟨"%53"⟩;Code.part19;dropfelt ⟨"%8"⟩;dropfelt ⟨"%4"⟩;dropfelt ⟨"%55"⟩;dropfelt ⟨"%56"⟩;dropfelt ⟨"%54"⟩;dropfelt ⟨"%57"⟩;Code.part20;dropfelt ⟨"%58"⟩) = prog
  unfold Code.part4
  MLIR
  rewrite [←eq]
...
lemma part4_cumulative_wp {in0: Felt} {data0 data1 data2 data3 data4 data5 data6 data7 data8 data9 data10 data11 data12 data13 data14 data15 data16 data17: Option Felt} :
      ...
      (part4_state_update
        {
          buffers :=
            (Map.empty[{ name := "in" : BufferVar }] ←ₘ [[some in0]])[{ name := "data" : BufferVar }] ←ₘ
              [[some (2 : Felt), some (0 : Felt), some (0 : Felt), some (3 : Felt), some (0 : Felt), none, none, none,
                  some (0 : Felt), some (0 : Felt), some (0 : Felt), some (0 : Felt), some (0 : Felt), some (0 : Felt),
                  some (0 : Felt), some (0 : Felt), none, none]],
          bufferWidths :=
            ((fun x => Map.empty x)[{ name := "data" : BufferVar }] ←ₘ (18 : ℕ))[{ name := "in" : BufferVar }] ←ₘ
              (1 : ℕ),
          cycle := (0 : ℕ),
          felts :=
            (((fun x => Map.empty x)[{ name := "%3" : FeltVar }] ←ₘ (0 : Felt))[{ name := "%7" : FeltVar }] ←ₘ
                (2 : Felt))[{ name := "%6" : FeltVar }] ←ₘ
              (3 : Felt),
