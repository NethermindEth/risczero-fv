...
def part4_state (st: State) : State :=
        ...
        ((((st.set! { name := "data" : BufferVar } (5 : ℕ) st.felts[{ name := "%3" : FeltVar }]!.get!).set!
                  { name := "data" : BufferVar } (7 : ℕ) st.felts[{ name := "%3" : FeltVar }]!.get!).set!
              { name := "data" : BufferVar } (6 : ℕ) st.felts[{ name := "%7" : FeltVar }]!.get!).set!
          { name := "data" : BufferVar } (16 : ℕ) st.felts[{ name := "%3" : FeltVar }]!.get!) 
      ...
      (part4_state_update
        {
          ...
          cycle := (0 : ℕ),
          felts :=
            ((Map.empty[{ name := "%3" : FeltVar }] ←ₘ (0 : Felt))[{ name := "%7" : FeltVar }] ←ₘ
