...
def part20_state (st: State) : State :=
   (withEqZero st.felts[{ name := "%58" : FeltVar }]!.get! st) 
  ...
  Code.getReturn
      (part20_state_update
        ({
            ...
            cycle := (0 : ℕ), felts := Map.empty, isFailed := ¬(4 : Felt) - (2 : Felt) * (2 : Felt) = (0 : Felt),
            props := Map.empty,
            vars :=
                          ...
                          some (0 : Felt) = data10 ∧
                            some (0 : Felt) = data11 ∧
                              some (0 : Felt) = data12 ∧
                                some (0 : Felt) = data13 ∧
                                  some (0 : Felt) = data14 ∧
                                    some (0 : Felt) = data15 ∧ some (0 : Felt) = data16 ∧ some (1 : Felt) = data17) ∧
      (4 : Felt) - (2 : Felt) * (2 : Felt) = (0 : Felt)  := by
