...
-- All credit to https://github.com/leanprover-community/mathlib4/blob/ab52fda385ddaebb1db141149631dbcc08f69e26/Mathlib/Data/Bitvec/Defs.lean
-- Small changes only.
...
def toFin {n : ℕ} (i : Bitvec n) : Fin (2 ^ n) := ⟨i.toNat % (2^n), by omega⟩
